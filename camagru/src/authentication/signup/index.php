...
<html>
  ...
  <body>
    ...
    <div class="intro has-text-centered">
      Join our great community for a complete experience.
      </br>
      <a href="/src/gallery" class="see-the-gallery">See the gallery</a>
    </div>
    <div class="already-have-an-account has-text-centered">
      <a href="/src/authentication/signin">Already have an account? </a>
    </div>
    <div class="section">
      <div class="container">
        <div class="columns">
          <div class="column is-half is-offset-one-quarter">
            <form action="javascript:signup()" enctype="multipart/form-data">
              <div class="field">
              ...
              <div class="has-text-centered">
                <button id="submitButton" type="submit" class="button submit-button is-rounded">Sign up</button>
              </div>
            </form>
          </div>
        </div>
